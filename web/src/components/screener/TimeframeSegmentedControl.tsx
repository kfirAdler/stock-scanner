...
export function TimeframeSegmentedControl({
  ...
  return (
    <div className="grid grid-cols-3 gap-1 rounded-2xl bg-surface-alt p-1 ring-1 ring-border dark:bg-white/[0.035] dark:ring-white/[0.05]">
      {items.map((item) => (
        <button
          key={item.id}
          type="button"
          ...
          className={clsx(
            ...
            value === item.id
              ? "bg-primary-soft text-primary shadow-sm ring-1 ring-primary/10 dark:bg-[linear-gradient(180deg,rgba(79,110,247,0.18),rgba(79,110,247,0.12))] dark:text-[#c7d2fe] dark:ring-[rgba(99,102,241,0.22)]"
              : "text-text-secondary hover:bg-surface-raised/75 hover:text-text dark:hover:bg-white/[0.05]"
          )}
        >
