      ...
      <button
        ...
        className={clsx(
          ...
          active
            ...
            : "bg-surface-raised text-text-secondary ring-1 ring-border hover:bg-surface hover:text-text hover:ring-border-strong dark:bg-[#172033] dark:ring-white/[0.05] dark:hover:bg-[#1e293b] dark:hover:ring-white/[0.07]"
        )}
      >
        {label}
      </button>
