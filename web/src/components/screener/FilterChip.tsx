    ...
    <div className="inline-flex items-center gap-1.5">
      <button
        ...
        className={clsx(
          ...
          active
            ? "border border-primary/35 bg-primary-soft text-primary shadow-[0_12px_30px_var(--color-primary-ring)]"
            : disabled
              ? "cursor-not-allowed border border-border/70 bg-surface/60 text-text-muted opacity-65"
