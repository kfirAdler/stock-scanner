    ...
    <div className="inline-flex items-center gap-1.5">
      <button
        ...
        className={clsx(
          ...
          active
            ? "bg-primary text-on-primary shadow-[0_10px_28px_rgba(30,64,175,0.22)]"
            : "bg-surface-raised text-text-secondary ring-1 ring-border hover:bg-surface hover:text-text hover:ring-border-strong"
        )}
      >
        {label}
      </button>
