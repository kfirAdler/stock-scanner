          ...
          return (
            <button
              ...
              className={clsx(
                ...
                active
                  ? "bg-surface-raised text-text shadow-sm ring-1 ring-border dark:bg-[#172033] dark:ring-white/[0.06]"
                  : "text-text-muted hover:bg-surface-raised/75 hover:text-text-secondary dark:hover:bg-[#1e293b]"
              )}
            >
              <span>{tab.label}</span>
              <span
