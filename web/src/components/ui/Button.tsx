...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-primary text-on-primary shadow-[0_14px_30px_var(--color-primary-ring)] hover:bg-primary-hover hover:shadow-[0_18px_36px_var(--color-primary-ring)] active:scale-[0.98] focus-visible:ring-primary/50 disabled:bg-primary/55 disabled:text-on-primary/80 disabled:shadow-none",
  secondary:
    "ui-control border-border-strong text-text shadow-[0_10px_22px_rgba(0,0,0,0.14)] hover:border-border-strong active:scale-[0.98] focus-visible:ring-primary/50",
  ghost:
