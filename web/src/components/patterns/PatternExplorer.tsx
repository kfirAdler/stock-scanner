...
export function PatternExplorer() {
  ...
  return <div className="page-shell page-stack">
    ...
    <PatternRequestPanel market={market} onViewResults={job=>{setRequestedJob(job);setMarket(job.market);setKind(job.pattern);setSearch('');setView('strict');setExpanded(null);}} />
    ...
    {displayStatus==='ready' && data && <>
      {data.coverage.total>0 && <ScanSummary data={data} pattern={requestedJob?.pattern} requested={!!requestedJob} />}
