...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/80 bg-[color:var(--color-surface-overlay)] backdrop-blur-2xl shadow-[0_12px_34px_rgba(0,0,0,0.22)]">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-3 sm:gap-8">
          <Link href="/" className="flex items-center gap-2 group" onClick={closeMenus}>
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary-hover shadow-[0_14px_28px_var(--color-primary-ring)] ring-1 ring-white/12">
            ...
            <span className="hidden text-base font-bold tracking-tight text-text transition-colors group-hover:text-[color:var(--color-neon)] sm:inline">
              {t("common.appName")}
            </span>
            {showMemberBadge && (
      ...
      {mobileNavOpen && (
        <div
          id="mobile-site-nav"
          className="border-t border-border/70 bg-surface-overlay/95 md:hidden"
        >
