...
export type PatternPayload = { rows: PatternSnapshot[]; coverage: { total: number; scanned: number; stale: number; insufficient: number }; updatedAt: string | null; diagnostics?: ChannelDiagnostics; durationSeconds?: number };
