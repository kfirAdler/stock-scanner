...
export type PatternMatch = { pattern: PatternKind; patternLabel: string; channelDirection?: ChannelDirection; confidence: number; lines: PatternLine[]; breakoutLevel: number; invalidationLevel: number; notes: string };
