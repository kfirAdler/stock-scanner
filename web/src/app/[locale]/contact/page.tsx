    ...
    <div className="page-shell page-stack max-w-3xl">
      ...
      <section className="page-card">
        ...
        {email ? (
          <a
            href={`mailto:${email}`}
            className="mt-3 inline-flex rounded-full border border-primary/20 bg-primary-soft px-4 py-2 text-sm font-bold text-primary transition-colors hover:bg-primary hover:text-on-primary"
          >
            {email}
          </a>
        ) : (
